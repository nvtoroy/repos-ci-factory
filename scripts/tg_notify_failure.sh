#!/usr/bin/env bash
# Сообщение о падении сборки. Идёт владельцу в личку (TELEGRAM_ADMIN_CHAT_ID),
# чтобы не шуметь в канале; без него — в канал.
# env: TELEGRAM_BOT_TOKEN TELEGRAM_CHAT_ID [TELEGRAM_ADMIN_CHAT_ID] NAME DISPLAY PLATFORM BRANCH BUILD_REF RUN_URL
set -euo pipefail
